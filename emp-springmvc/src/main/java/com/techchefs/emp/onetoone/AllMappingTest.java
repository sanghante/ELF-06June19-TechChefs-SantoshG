...
import com.techchefs.emp.manytoone.DepartmentInfoBean;
...
//		bean1.setId(20);
//		bean1.setName("Praveen");
//		bean1.setManagerId(bean);
//		bean1.setDesignation("CEO");
//
//		EmployeeInfoBean bean2 = new EmployeeInfoBean();
//		bean2.setId(30);
//		bean2.setName("Giridhar");
//		bean2.setManagerId(bean1);
...
//		EmployeeInfoBean bean2 = impl.getEmployeeInfoBean(2);
//		
...
//	}
	 ...
	 * SimpleDateFormat("yyyy-mm-dd"); Date dateDOB = null; try { dateDOB =
	 * dateFormat.parse("1990-05-01"); } catch (ParseException e) {
	 * log.severe(Arrays.toString(e.getStackTrace())); } Date dateJoin = null; try {
	 * dateJoin = dateFormat.parse("2019-05-01"); } catch (ParseException e) {
	 * log.severe(Arrays.toString(e.getStackTrace())); }
	 * 
	 * EmployeeInfoBean empinfo1 = new EmployeeInfoBean(); empinfo1.setId(2);
	 * empinfo1.setName("Santosh"); empinfo1.setAge(25); empinfo1.setGender("Male");
	 * empinfo1.setSalary(135000); empinfo1.setPhoneNumber("565689798");
	 * empinfo1.setEmail("san@gmail.com"); empinfo1.setDesignation("CEO");
	 * empinfo1.setDob(dateDOB); empinfo1.setAccountNumber(98798089);
	 * empinfo1.setJoiningDate(dateJoin); empinfo1.setDepartmentId(30);
	 * 
	 * EmployeeInfoBean empinfo = new EmployeeInfoBean(); empinfo.setId(1);
	 * empinfo.setName("Nistha"); empinfo.setAge(25); empinfo.setGender("Female");
	 * empinfo.setSalary(35000); empinfo.setPhoneNumber("565689798");
	 * empinfo.setEmail("nish@gmail.com"); empinfo.setDesignation("Manager");
	 * empinfo.setDob(dateDOB); empinfo.setAccountNumber(98798089);
	 * empinfo.setJoiningDate(dateJoin); empinfo.setDepartmentId(30);
	 * empinfo.setManagerId(empinfo1);
	 * 
	 * EmployeeOtherInfoBean otherInfo = new EmployeeOtherInfoBean();
	 * //otherInfo.setId(1); otherInfo.setEmployeeInfoBean(empinfo);
	 * otherInfo.setIsmarried(false); otherInfo.setPan("CMFDG2341k");
	 * otherInfo.setBloodGrp("A+"); otherInfo.setEmergencyContactName("Rajesh");
	 * otherInfo.setEmergencyContactNumber(678687980);
	 * otherInfo.setNationality("Indian"); otherInfo.setReligion("Hindu");
	 * otherInfo.setFatherName("Mahadev"); otherInfo.setMotherName("Mahamata");
	 * otherInfo.setPassport("M89778"); otherInfo.setAadhar(787889L);
	 * 
	 ...
	 * educationPKBean1.setInfoBean(empinfo); EmployeeEducationInfoBean
	 * educationInfoBean1 = new EmployeeEducationInfoBean();
	 ...
	 * educationPKBean2.setInfoBean(empinfo); EmployeeEducationInfoBean
	 * educationInfoBean2 = new EmployeeEducationInfoBean();
	 ...
	 * HibernateImpl impl = new HibernateImpl();
	 * 
	 * impl.createEmployee(empinfo,otherInfo, Arrays.asList(addressInfoBean1,
	 ...
	 * trainingInfoBean.setCourseType("Online"); trainingInfoBean.setDuration(30);
